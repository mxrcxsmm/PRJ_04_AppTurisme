...
document.getElementById('createPuntoControlForm').addEventListener('submit', function(e) {
    // Ejecutamos las validaciones de cada campo
    validateLugar();
    validateDescripcion();
    validatePista();
    validatePrueba();

    // Revisamos si hay errores en los <small>
